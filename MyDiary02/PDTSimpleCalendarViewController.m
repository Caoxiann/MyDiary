...
- (void)viewDidLoad
{
    ...
    self.seg=[[UISegmentedControl alloc]initWithFrame:CGRectMake(view.frame.size.width/2.0-105, 1, 210, 20)];
    ...
    //set tableView
    UITableView *tableView=[[UITableView alloc]initWithFrame:CGRectMake(30, self.collectionView.frame.origin.y+self.collectionView.frame.size.height-20, self.view.frame.size.width-60, self.view.frame.size.height-self.collectionView.frame.origin.y-self.collectionView.frame.size.height-75) style:UITableViewStyleGrouped];
    ...
    [tableView registerNib:[UINib nibWithNibName:@"MyTableViewCell" bundle:nil] forCellReuseIdentifier:@"MyCell"];
}
//
-(void)pressToolBtn02
{

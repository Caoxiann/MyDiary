...
-(void)pressBackBtnWithoutText
{
    ...
    else
    {
        ...
        TableViewCellDataSource *data=[[TableViewCellDataSource alloc]initWithText:self.textView.text Hour:[components hour] Minute:[components minute] Place:@" 四川成都"];
...
-(void)pressBackBtnWithText
{
    ...
    TableViewCellDataSource *data=[[TableViewCellDataSource alloc]initWithText:self.textView.text Hour:self.originData.hour Minute:self.originData.minute Place:@"四川成都"];

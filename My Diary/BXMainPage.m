...
//创建UISegmentControl对象
    ...
    mainSegmentControl.frame=CGRectMake(30, 40, 260, 30);
...
//创建UILabel对象
    ...
    _label.frame=CGRectMake(120, 85, 100, 30);

...
/*-(void)chooseSeg:(UISegmentedControl *)segmenControl
{
    if (segmenControl.selectedSegmentIndex == 1) {
        VCDaily *daily=[[VCDaily alloc]init];
        [self.nav pushViewController:daily animated:NO];
    }
    else if(segmenControl.selectedSegmentIndex == 2)
    {
        VCDiary *diary=[[VCDiary alloc]init];
        [self.nav pushViewController:diary animated:NO];
    }
}*/

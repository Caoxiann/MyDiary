...
@interface BXCalendar () <UIScrollViewDelegate, BXCalendarItemDelegate>

@property (strong, nonatomic) NSDate *date;

@property (strong, nonatomic) UIButton *titleButton;
@property (strong, nonatomic) UIScrollView *scrollView;
@property (strong, nonatomic) BXCalendarItem *leftCalendarItem;
@property (strong, nonatomic) BXCalendarItem *centerCalendarItem;
@property (strong, nonatomic) BXCalendarItem *rightCalendarItem;
...
- (void)setupTitleBar
{
    ...
    UIButton *leftButton = [[UIButton alloc] initWithFrame:CGRectMake(DeviceWidth*80/100,7, 25, 15)];
    ...
    UIButton *rightButton = [[UIButton alloc] initWithFrame:CGRectMake(titleView.frame.size.width - 37,7, 25, 15)];
    ...
    titleButton.frame=CGRectMake(5, -8, 100, 44);
...
- (void)setupWeekHeader
{
    ...
    for (int i = 0; i < count; i++) {
        UILabel *weekdayLabel = [[UILabel alloc] initWithFrame:CGRectMake(offsetX, 40, (DeviceWidth - 10) / count, 10)];
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(15, 60, DeviceWidth - 30, 1)];
...
- (void)setupScrollView
{
    ...
    [self.scrollView setFrame:CGRectMake(0, 60, DeviceWidth, self.centerCalendarItem.frame.size.height)];
...
- (void)setupCalendarItems
{
    ...
    self.centerCalendarItem = [[BXCalendarItem alloc] init];
    ...
    self.rightCalendarItem = [[BXCalendarItem alloc] init];
...
#pragma mark - BXCalendarItemDelegate
